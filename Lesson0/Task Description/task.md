...
If you use two monitors, consider switching the Task Description panel to floating mode and moving it to the second screen, or just placing it near the main IDE window. To do this, click the tool window settings ![](images/moreVertical.svg) icon :
